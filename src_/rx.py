...
for i in range(0, 360, phase_shift):
    ...
    # y_points_layer2 = []
    angle = start_angle
    current_x, curve_angle = calc_radius(radius, start_angle - math.radians(i), 1, open_angle, amplitude)
    current_x = current_x * math.sin(start_angle)
    current_y, curve_angle = calc_radius(radius, start_angle - math.radians(i), 1, open_angle, amplitude)
    current_y = current_y * math.cos(start_angle)
    ...
    while angle < end_angle:
        angle = angle + step
        next_x, curve_angle = calc_radius(radius, angle - math.radians(i), 1, open_angle, amplitude)
        next_x = next_x * math.sin(angle)
        next_y, curve_angle = calc_radius(radius, angle - math.radians(i), 1, open_angle, amplitude)
        ...
        plt.plot([current_x, next_x], [current_y, next_y], color=current_color)
        current_x = next_x
        current_y = next_y
